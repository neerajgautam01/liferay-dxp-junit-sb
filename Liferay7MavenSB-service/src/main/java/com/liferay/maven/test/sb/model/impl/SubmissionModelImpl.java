...
import com.liferay.maven.test.sb.model.SubmissionModel;
...
/**
 * The base model implementation for the Submission service. Represents a row in the &quot;DXP_Submission&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class SubmissionModelImpl extends BaseModelImpl<Submission>
	 ...
	 */
	public static final String TABLE_NAME = "DXP_Submission";
	...
	public static final String TABLE_SQL_CREATE = "create table DXP_Submission (submissionId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,assignmentId LONG,studentId LONG,submitDate DATE null,comment_ VARCHAR(75) null,grade INTEGER)";
	public static final String TABLE_SQL_DROP = "drop table DXP_Submission";
	public static final String ORDER_BY_JPQL = " ORDER BY submission.submissionId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY DXP_Submission.submissionId ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.maven.test.sb.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.maven.test.sb.model.Submission"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.maven.test.sb.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.maven.test.sb.model.Submission"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.maven.test.sb.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.maven.test.sb.model.Submission"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.maven.test.sb.service.util.ServiceProps.get(
				"lock.expiration.time.com.liferay.maven.test.sb.model.Submission"));
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.maven.test.sb.model.Submission");
