...
import com.liferay.maven.test.sb.exception.NoSuchAssignmentException;
import com.liferay.maven.test.sb.model.Assignment;
import com.liferay.maven.test.sb.service.AssignmentLocalServiceUtil;
import com.liferay.maven.test.sb.service.persistence.AssignmentPersistence;
import com.liferay.maven.test.sb.service.persistence.AssignmentUtil;
...
public class AssignmentPersistenceTest {
	...
	protected OrderByComparator<Assignment> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("DXP_Assignment", "uuid",
			true, "assignmentId", true, "groupId", true, "companyId", true,
